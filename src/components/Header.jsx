...
export default function Header() {
  ...
  useEffect(() => {
    fetch(
      "https://kj3jc5vpz3eylnbdrw6xhp5tjy0jznva.lambda-url.us-east-1.on.aws/"
    )
      ...
      <div className="flex justify-center items-center text-center px-12">
        <header>
          ...
          <h1 id="headerText" className="text-lg mt-5 leading-tight">
            ...
            memorable and engaging web experiences.
          </h1>
          <div className="flex justify-center mt-12">
            <a
              href="https://www.linkedin.com/in/mgaynor228/"
              rel="noopener noreferrer nofollow"
              target="_blank"
            >
              {" "}
              <TfiLinkedin
                className="hover:text-gray-600 transition delay-200"
                size="3.5em"
              />{" "}
            </a>
            <a
              className="ml-5"
              href="https://github.com/Mgaynor2022"
              rel="noopener noreferrer nofollow"
              target="_blank"
            >
              {" "}
            ...
            <Link className="ml-5" to="#contact" smooth>
              {" "}
              <AiOutlineMail
                className="hover:text-gray-600 transition delay-200"
                size="3.5em"
        ...
        <div className="my-4" id="counter">Views: {data}</div>
        </header>
      </div>
    </div>
  );
