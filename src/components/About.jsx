    ...
    return (
        <div id='about'className="flex bg-gray-50 items-center px-12 lg:px-24 p-10 ">
				<div id='aboutMe' className=" flex flex-col items-center">
					...
					<p id='aboutMe-text' className=" font-normal text-lg text-center mb-6 px-20">My time in the military and fitness journey showed 
					...
					<a href='https://docs.google.com/document/d/1huQQ0CeLkIBLc7HfL_KeCxpDcLv16NPbJs9Kisd35PI/edit' target="_blank" rel="noopener noreferrer">
