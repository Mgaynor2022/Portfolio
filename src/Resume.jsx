    ...
    return(
        <div>
            <div class="flex justify-center items-center p-2">
                ...
                <a href='https://github.com/Mgaynor2022/Mgaynor2022.github.io/blob/main/src/resume/SoftwareEngineerResume.pdf' download={"Michael Gaynor Resume"} target="_blank" rel="noopener noreferrer">
